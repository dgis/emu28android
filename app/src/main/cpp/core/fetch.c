...
static JMPTAB o81_[] =
{
	...
	(LPCVOID) o816,			F,
	(LPCVOID) o817,			F,
//	(LPCVOID) o818_,		4,				// r=r+CON fs,n / r=r-CON fs,n group
	(LPCVOID) o_invalid3,	F,				// 1LK7
//	(LPCVOID) o819_,		4,				// rSRB.F fs group
	(LPCVOID) o_invalid3,	F,				// 1LK7
...
static JMPTAB o808_[] =
{
	(LPCVOID) o8080,		F,
	(LPCVOID) o8081_,		4,
//	(LPCVOID) o8082X,		F,				// LAHEX
	(LPCVOID) o_invalid4,	F,				// 1LK7
//	(LPCVOID) o8083,		F,				// BUSCB
	(LPCVOID) o_invalid4,	F,				// 1LK7
//	(LPCVOID) o8084n,		F,				// ABIT=0 n
	(LPCVOID) o_invalid4,	F,				// 1LK7
//	(LPCVOID) o8085n,		F,				// ABIT=1 n
	(LPCVOID) o_invalid4,	F,				// 1LK7
//	(LPCVOID) o8086n,		F,				// ?ABIT=0 n RTNYES/GOYES
	(LPCVOID) o_invalid4,	F,				// 1LK7
//	(LPCVOID) o8087n,		F,				// ?ABIT=1 n RTNYES/GOYES
	(LPCVOID) o_invalid4,	F,				// 1LK7
//	(LPCVOID) o8088n,		F,				// CBIT=0 n
	(LPCVOID) o_invalid4,	F,				// 1LK7
//	(LPCVOID) o8089n,		F,				// CBIT=1 n
	(LPCVOID) o_invalid4,	F,				// 1LK7
//	(LPCVOID) o808An,		F,				// ?CBIT=0 n RTNYES/GOYES
	(LPCVOID) o_invalid4,	F,				// 1LK7
//	(LPCVOID) o808Bn,		F,				// ?CBIT=1 n RTNYES/GOYES
	(LPCVOID) o_invalid4,	F,				// 1LK7
	(LPCVOID) o808C,		F,
//	(LPCVOID) o808D,		F,				// BUSCD
	(LPCVOID) o_invalid4,	F,				// 1LK7
//	(LPCVOID) o808E,		F,				// PC=(C)
	(LPCVOID) o_invalid4,	F,				// 1LK7
	(LPCVOID) o808F,		F
};
